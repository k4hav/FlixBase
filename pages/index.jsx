...
import { Film, Inbox, TrendingUp, Tv2, Sparkles, Download } from 'lucide-react';
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.6 }}
            ...
            {types.map(t => (
              <motion.button key={t} onClick={() => setFilter(t)}
                ...
                {t === 'Anime' && <span className="ml-1" style={{ fontSize: '10px' }}>✦</span>}
              </motion.button>
            ))}
          </motion.div>
